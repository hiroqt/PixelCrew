...
name: polish
description: >-
  Final shipping readiness pass: design system token alignment, type checks, visual cleanup. Triggers Floor 42 command /polish.
---

# /polish — PixelCrew Command

Perform PixelCrew shipping polish pass:
