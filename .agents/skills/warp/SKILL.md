...
name: warp
description: >-
  Full-stack performance tuning: streaming SSR, bundle minification, AST prompt caching (~72% savings). Triggers Floor 42 command /warp.
---

# /warp — PixelCrew Command

Apply PixelCrew Warp performance optimizations:
