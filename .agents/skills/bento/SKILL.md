...
name: bento
description: >-
  Reorganizes sections into asymmetric Bento grids and dynamic viewport flow. Triggers Floor 42 command /bento.
---

# /bento — PixelCrew Command

Restructure layout into Asymmetric Bento grid patterns for: $ARGUMENTS.
