...
name: recap
description: >-
  Generates a token-optimized recap of recent git changes, commits, diff stats, and file operations. Triggers Floor 42 command /recap.
---

# /recap — PixelCrew Command

Execute a token-optimized session recap for the last $ARGUMENTS commits:
