...
name: render
description: >-
  6-dimension Anti-AI design & UX review (Originality, Hierarchy, Typography, Layout, Brand, Slop Penalty >= 8.5/10). Triggers Floor 42 command /render.
---

# /render — PixelCrew Command

Run a rigorous 6-dimension Anti-AI design review:
