...
name: blueprint
description: >-
  Dynamic DAG planning, wireframes & specifications before writing code. Triggers Floor 42 command /blueprint.
---

# /blueprint — PixelCrew Command

Generate a comprehensive architectural blueprint for: $ARGUMENTS.
