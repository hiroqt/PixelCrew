...
name: init
description: >-
  Scans codebase architecture, configures .pixel-crew/, and adapts agent squad. Triggers Floor 42 command /init.
---

# /init — PixelCrew Command

Initialize and adapt PixelCrew workspace:
