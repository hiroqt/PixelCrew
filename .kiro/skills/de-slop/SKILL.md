...
name: de-slop
description: >-
  Strips AI cliché copywriting and generic templates with grounded value propositions. Triggers Floor 42 command /de-slop.
---

# /de-slop — PixelCrew Command

Run PixelCrew De-Slop copy and design sanitization for: $ARGUMENTS.
