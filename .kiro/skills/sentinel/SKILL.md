...
name: sentinel
description: >-
  Security & resilience pass: OWASP checks, SQL injection prevention, RFC 7807 envelopes, rate limiting. Triggers Floor 42 command /sentinel.
---

# /sentinel — PixelCrew Command

Execute PixelCrew Sentinel security audit:
