...
name: typeset
description: >-
  Mathematical fluid clamp() type scales, distinct font pairings, expressive hierarchy. Triggers Floor 42 command /typeset.
---

# /typeset — PixelCrew Command

Apply PixelCrew Typeset typography strategy for: $ARGUMENTS.
