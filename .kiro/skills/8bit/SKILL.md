...
name: 8bit
description: >-
  Retro arcade delight: procedural 8-bit Web Audio chimes, CRT phosphor scanlines, tactile joy. Triggers Floor 42 command /8bit.
---

# /8bit — PixelCrew Command

Inject retro 8-bit arcade delight into the interface:
