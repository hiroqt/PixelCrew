...
name: assemble
description: >-
  Full shape-then-build multi-agent sprint pipeline from brief to production code. Triggers Floor 42 command /assemble.
---

# /assemble — PixelCrew Command

Execute the PixelCrew /assemble sprint pipeline for: $ARGUMENTS.
